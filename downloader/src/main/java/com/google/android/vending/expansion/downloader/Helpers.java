...
public class Helpers {
     ...
     */
    @NonNull
    public static File getFilesystemRoot(@NonNull String path) {
     ...
     */
    @NonNull
    public static String getExpansionAPKFileName(@NonNull Context c, boolean mainFile, int versionCode) {
    ...
    @NonNull
    static public String getSaveFilePath(@NonNull Context c) {
