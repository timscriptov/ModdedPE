...
public class ZippedNMod extends NMod {
    private final MinecraftInfo minecraftInfo;
    ...
    public ZippedNMod(String packageName, Context thisContext, File file) throws IOException {
        ...
        this.mFilePath = file;
        this.minecraftInfo = new MinecraftInfo(thisContext);
    ...
    public NModPreloadBean copyNModFiles() throws IOException {
        ...
        while ((entry = zipInput.getNextEntry()) != null) {
            if (!entry.isDirectory() && entry.getName().startsWith("lib" + File.separator + minecraftInfo.getMinecraftABI() + File.separator)) {
