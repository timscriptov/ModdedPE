...
public class NModJSONEditor {
    ...
    private @NotNull String readJsonFromParents(String path) throws IOException {
    ...
    private @NotNull String readJsonFromThis(String path) throws IOException {
