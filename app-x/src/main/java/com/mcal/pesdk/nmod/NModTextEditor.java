...
public class NModTextEditor {
    ...
    private @NotNull String readTextFromParents(String path) throws IOException {
    ...
    private @NotNull String readTextFromThis(String path) throws IOException {
