...
class NModDataLoader {
    ...
    private static @NotNull String fromArrayList(ArrayList<String> arrayList) {
    ...
    public void setIsEnabled(NMod nmod, boolean isEnabled) {
        if (isEnabled)
            addNewEnabled(nmod);
        else
            removeEnabled(nmod);
    ...
    public void upNMod(@NotNull NMod nmod) {
        SharedPreferences preferences = getSharedPreferences();
        ArrayList<String> enabledList = getEnabledList();
    ...
    public void downNMod(@NotNull NMod nmod) {
        SharedPreferences preferences = getSharedPreferences();
        ArrayList<String> enabledList = getEnabledList();
        int index = enabledList.indexOf(nmod.getPackageName());
