...
public class ExtractFailedException extends Exception {
    ...
    public String toTypeString() {
        return switch (mType) {
            case TYPE_JSON_SYNTAX_EXCEPTION -> "JSON_SYNTAX_EXCEPTION";
            case TYPE_INEQUAL_PACKAGE_NAME -> "INEQUAL_PACKAGE_NAME";
            case TYPE_DECODE_FAILED -> "DECODE_FAILED";
            case TYPE_IO_EXCEPTION -> "IO_EXCEPTION";
            case TYPE_INVAILD_PACKAGE_NAME -> "INVAILD_PACKAGE_NAME";
            case TYPE_PACKAGE_NOT_FOUND -> "PACKAGE_NOT_FOUND";
            case TYPE_NO_MANIFEST -> "NO_MANIFEST";
            case TYPE_UNDEFINED_PACKAGE_NAME -> "UNDEFINED_PACKAGE_NAME";
            case TYPE_UNEXPECTED -> "UNEXPECTED";
            case TYPE_REDUNDANT_MANIFEST -> "REDUNDANT_MANIFEST";
            default -> "null";
        };
    }
}
