...
public abstract class NMod {
    ...
    private final ArrayList<NModWarning> mWarnings = new ArrayList<>();
    ...
    public final int getVersionCode() {
        if (mInfo != null && mInfo.version_code > 0) {
            return mInfo.version_code;
        }
        return -1;
    }
    ...
    final void preload() {
        ...
        try {
            ...
            Gson gson = new Gson();
            mInfo = gson.fromJson(tmp.toString(), NModInfo.class);
