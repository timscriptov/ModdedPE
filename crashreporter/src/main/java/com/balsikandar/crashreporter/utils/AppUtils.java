...
public class AppUtils {
    private static String getCurrentLauncherApp(@NotNull Context context) {
        String str = "";
    ...
    private static @NotNull String getUserIdentity(Context context) {
    ...
    public static @NotNull String getDeviceDetails(Context context) {
    ...
    private static @NotNull String getDeviceId(Context context) {
    ...
    private static @Nullable String getAndroidDeviceId(@NotNull Context context) {
    ...
    private static int getAppVersion(@NotNull Context context) {
        try {
