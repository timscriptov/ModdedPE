...
public class MainActivity extends NativeActivity implements View.OnKeyListener, FilePickerManagerHandler {
    ...
    private String mSentryEndpointConfigUrl = "";
    private SentryEndpointConfig mSentryEndpointBedrockPublish = new SentryEndpointConfig(this.mSentryEndpointConfigUrl, "", "");
    ...
    private SentryEndpointConfig mSentryEndpointAndroidChromebook = new SentryEndpointConfig(this.mSentryEndpointConfigUrl, "", "");
    private SentryEndpointConfig mSentryEndpointAndroidChromebookTrial = new SentryEndpointConfig(this.mSentryEndpointConfigUrl, "", "");
    ...
    private final String REQUEST_PUSH_PERMISSION_STRING = "android.permission.POST_NOTIFICATIONS";
...
//        PlayIntegrity.requestIntegrityToken(getApplicationContext(), nonce).addOnCompleteListener(this::m155xe68e3248);
//    }

//    public void m155xe68e3248(Task<IntegrityTokenResponse> task) {
//        try {
//            if (task.isSuccessful()) {
//                String token = task.getResult().token();
//                nativeSetIntegrityToken(token);
//            } else {
//                nativeSetIntegrityTokenErrorMessage(task.getException().getMessage());
//            }
//        } catch (Exception e) {
//            Log.e("ModdedPE", "Failed to retrieve integrity token result: " + e.getMessage());
//            nativeSetIntegrityTokenErrorMessage(e.getMessage());
//        }
//    }
}
